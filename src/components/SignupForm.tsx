    ...
    <div id="signup" className="mx-auto max-w-2xl">
      <div className="border-brand-border bg-brand-surface rounded-2xl border p-8 shadow-lg">
        <div className="mb-8 text-center">
          <h3 className="text-brand-ink mb-2 text-2xl font-bold">Get PromptReady free</h3>
          <p className="text-brand-muted">
            Enter your email to get PromptReady updates and release details.
          </p>
        ...
        <form onSubmit={handleSignup} className="space-y-6">
          ...
          {errorMessage && (
            <div className="border-brand-accent/30 bg-brand-accent/8 text-brand-ink rounded-lg border p-3 text-sm">
          ...
          <button
            ...
            className="bg-brand-accent hover:bg-brand-accent-hover w-full transform cursor-pointer rounded-lg px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 disabled:transform-none disabled:cursor-not-allowed disabled:opacity-50"
          >
