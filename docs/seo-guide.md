...
<Helmet>
  ...
  <meta
    name="description"
    content="One-click extension that turns messy pages, docs, articles, and Reddit threads into structured text for ChatGPT, Claude, or your LLM workflow — with private, on-device parsing."
  />
...
<meta
  name="description"
  content="Tired of messy copy-pasting? PromptReady is the one-click extension that cleans web pages into private Markdown context for your LLM."
/>
<link rel="canonical" href="https://promptready.app/" />
...
_Ensures React Router works on Cloudflare Pages_
...
export const seo = {
  ...
  description:
    'One-click extension that turns messy pages, docs, articles, and Reddit threads into structured text for ChatGPT, Claude, or your LLM workflow — with private, on-device parsing.',
